...
class PuzzleSelectionGraphic:
    def __init__(self, screen):
        ...
        self.mid_background_color = COLORS["SKY"] # цвет фона
        screen_width, screen_height = pygame.display.get_window_size()

        # фон выбора головоломки
        # оставить 1/10 отступа со всех сторон
        ...
        # нарисовать кнопку для каждой головоломки на этой странице
        # отступы измеряются изнутри mid_background
